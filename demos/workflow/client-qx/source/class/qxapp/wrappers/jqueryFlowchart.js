...
qx.Class.define('qxapp.wrappers.jqueryFlowchart', {
    ...
    construct: function() {
        ...
        // initialize the script loading
        let jquery_path = '../resource/jquery/jquery-3.3.1' + min + '.js';
        let jquery_ui_path = '../resource/jquery/jquery-ui-1.12.1' + min + '.js';
        let jquery_ui_css_path = '../resource/jquery/jquery-ui-1.12.1' + min + '.css';
        let flowchart_path = '../resource/jquery-flowchart/jquery.flowchart' + min + '.js';
        let flowchart_css_path = '../resource/jquery-flowchart/jquery.flowchart' + min + '.css';
        let flowchart_z43_css_path = '../resource/jquery-flowchart/jquery.flowchart.z43' + min + '.css';
