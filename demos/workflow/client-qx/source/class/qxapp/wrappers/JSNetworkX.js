...
qx.Class.define('qxapp.wrappers.JSNetworkX', {
  ...
  construct: function() {
    ...
    let d3Path = '../resource/jsnetworkx/d3.v3.min.js';
    let jsnetworkxPath = '../resource/jsnetworkx/jsnetworkx.js';
    ...
    dynLoader.addListenerOnce('ready', function(e) {
      console.log(jsnetworkxPath + ' loaded');
  ...
  members: {
    ...
    AddStuff: function(loadExample) {
      for (let n of this._mainGraph.nodes()) {
